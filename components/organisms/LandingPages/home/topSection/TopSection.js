...
import stairs from "@images/Hero image (1).png";
...
const TopSection = () => {
  return (
    <section className={`font-mulish px-4 pt-10 bg-HavannaGreen-light smallLaptop:px-[100px] `}>
      <div className="">
            ...
            <Animate.Fade bottom>
              <div className="mr-10">
                <h1 className="text-[32px] tablet:text-[40px] smallLaptop:text-[60px] leading-10 font-extrabold font-mulish smallLaptop:leading-[72px] text-primary">
                  ...
                  can
                  <span className="text-HavannaGreen-secondary"> Invest </span>in real estate.
                </h1>
