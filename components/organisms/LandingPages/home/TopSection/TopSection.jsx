...
const TopSection = () => {
  return (
    <section className="font-mulish pt-6 bg-HavannaGreen-100 px-5 smallLaptop:px-[120px] tablet:pt-[133px] pb-[52px]">
      <div className="">
        <div className="tablet:flex tablet:justify-between ">
          ...
          <div className="flex justify-center mt-11 tablet:mt-0 tablet:ml-12 smallLaptop:ml-10 bigLaptop:ml-[100px]">
            <Animate.Zoom>
              <div>
