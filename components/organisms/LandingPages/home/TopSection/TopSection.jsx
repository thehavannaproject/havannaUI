    ...
    <section className="font-mulish pt-6 bg-HavannaGreen-100 px-5 tablet:px-[120px] tablet:pt-[133px] pb-[52px]">
      <div className="">
        <div className="tablet:flex tablet:justify-between ">
          <div className="">
            <Animate.Fade bottom>
              <h1 className="text-36 tablet:text-[46px] smallLaptop:text-[60px] tablet:leading-[72px] font-bold text-HavannaGreen-primary leading-[44px] text-center tablet:text-left">
