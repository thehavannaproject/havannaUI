      ...
      <div className="smallLaptop:flex">
        <Animate.Fade bottom>
          <div className=" smallLaptop:flex smallLaptop:justify-center smallLaptop:items-center">
            <div>
              <h2 className="text-24 font-bold text-HavannaGreen-primary text-center smallLaptop:text-left smallLaptop:text-36">
                Opportunities made for <span className="text-HavannaGreen-tertiaryMain">you</span>.
              </h2>
              <p className="font-medium text-14 tablet:text-16 leading-5 text-center smallLaptop:text-left mt-4">
