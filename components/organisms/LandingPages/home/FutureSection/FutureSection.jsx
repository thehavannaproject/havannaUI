  ...
  return (
    <section className="font-mulish px-5 py-[60px]">
        <div className="">
          <div className="">
            <Animate.Fade bottom>
              <h2 className="text-center text-24 font-bold text-HavannaGreen-primary leading-8">Build the future <span className="text-HavannaGreen-tertiaryMain">you</span> want.</h2>
