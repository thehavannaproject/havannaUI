                    ...
                    <div className="w-full lg:w-6/12 relative pt-6 lg:pt-16 pb-10 lg:pb-20">
                        <Animate.Fade bottom>
                            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold text-primary">
                                Trade your virtual slot for money.
                            </h1>
                            <p className="text-default text-base lg:text-lg mt-4 md:mt-6 lg:mt-8 w-full lg:w-10/12 ">
                                Can’t wait for the holding period?
                                Explore the quickest and most convenient way to sell your slots for quick cash.
                            </p>
                            <div className="pt-14 lg:pt-16 flex">
                                <Button title="SELL NOW" isLink={false} />
                            </div>
                        </Animate.Fade>
                    </div>
