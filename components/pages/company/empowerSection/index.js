...
import InvestorImage from "../../../../public/images/webp/investor.webp"
            ...
            <div className="container px-4 mx-auto pt-24 md:pt-32 lg:pt-40 pb-32 lg:pb-40 flex flex-row flex-wrap justify-center">
                    ...
                    <Animate.Fade bottom>
                        <div className='relative'>
                            ...
                            <div className='relative z-10'>
                                <h1 className='text-2xl md:text-3xl lg:text-4xl font-semibold' style={{ color: "#077771" }}>Empowering investors</h1>
                            </div>

                        </div>
                        <p className='w-full mt-6 lg:mt-10 text-sm-15 lg:text-default leading-7'>
                            Havanna was built with the aim of
                            empowering average investors and closing the wealth gap. For the
                            everyday investor, we are dedicated to demystifying the
                            wealth-building process. From first-time investors to
                            asset managers, our platform allows anybody to
                            confidently analyze, purchase, and own virtual
                            investment properties from anywhere in the world.
                            <br /><br />
                            Our goal is to make investing in real estate significantly
                            more accessible, cost-effective, and effortless. We simply
                            make your dream and aspirations come true.
                        </p>
                    </Animate.Fade>
                </div>
                <div className='w-full lg:w-7/12 relative mt-10 md:mt-0'>
                    <div className='w-10/12 md:w-9/12 mx-auto relative'>
                        ...
                        <Image src={InvestorImage} alt="Invest" />
