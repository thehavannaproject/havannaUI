...
const TransactionProcessingModal = ({ setShowSuccessModal }) => {
  return (
    <div className="h-screen w-full absolute top-0 left-0 flex justify-center items-center bg-white z-50">
      <div className="flex flex-col justify-center items-center">
        ...
        <CustomButton
          customClass="bg-HavannaGreen-primary mt-24 flex font-bold text-16 justify-center items-center text-white w-[684px] h-[58px] rounded-lg "
