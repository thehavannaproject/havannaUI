...
const Header = ({ isDark = false }) => {
  return (
    <>
      <div className="hidden bg-HavannaGreen-light tablet:sticky shadow-lg tablet:w-full tablet:top-0 tablet:z-50 tablet:block relative font-mulish px-4 py-3 tablet:px-10 tablet:py-5 smallLaptop:px-[120px] smallLaptop:py-8">
