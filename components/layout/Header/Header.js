      ...
      <div className="hidden tablet:block relative font-mulish px-4 py-3 tablet:px-10 tablet:py-5 smallLaptop:px-[120px] smallLaptop:py-8">
        <div className=" tablet:flex tablet:justify-between">
          ...
          <div className=" tablet:block mt-3">
            <div
              className={`tablet:flex tablet:gap-8 smallLaptop:gap-16  font-mulish text-16 font-bold  ${
          ...
          >
            ...
            <NavItem
              className="bg-HavannaGreen-primary text-white px-6 rounded-lg !flex !justify-center !items-center"
